            ...
            {spotData && (
              <CardStyle key={surfSpot.id}>
                <div>
                  ...
                  <StyledCardDetails>
                    <p className={surfSpot.swell_direction?.includes(spotData.swellDir) ? "text-green-400": ""}>
                      Current Swell Direction: {spotData.swellDir}{" "}
                    </p>
                    <p className={surfSpot.wind_direction?.includes(spotData.windDir) ? "text-green-400" : ""}>
                  ...
                  <button
                    onClick={() =>
                      createCollectionSpot(this.state.collectionId, surfSpot.id)
                    }
                  >
                    +
                  </button>
